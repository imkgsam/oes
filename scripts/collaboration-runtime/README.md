...
- `src/cleanup.ts`: Stage batch authorization narrowing, observation-bound partial-failure preservation, post-removal verification, and complete cleanup-only diff verification.

...
import { GatewayTerminalDeviceGrpcClient } from '../../../../../../../src/common/grpc/gateway-terminal-device-grpc.client'
import {
  GatewayAssetGrpcClient,
  GatewayTrustedGrpcExecutionProducer
} from '../../../../../../../src/common/grpc'
...
import { AuthBffModule } from '../../../../../../../src/modules/auth-bff/auth-bff.module'
import {
  GatewayFoundationTrustedGrpcExecutionProducer,
  TrustedAuthGrpcClient
} from '../../../../../../../src/infrastructure/grpc/trusted-auth.grpc.client'
import { TrustedIdentityGrpcClient } from '../../../../../../../src/infrastructure/grpc/trusted-identity.grpc.client'
import { TrustedPermissionGrpcClient } from '../../../../../../../src/infrastructure/grpc/trusted-permission.grpc.client'
import { TrustedTenantOrgGrpcClient } from '../../../../../../../src/infrastructure/grpc/trusted-tenant-org.grpc.client'
...
import { GatewaySessionAuthGuard } from '../../../../../../../src/common/guards/gateway-session-auth.guard'
...
import { createGatewaySourceCredentialProviders } from '../../../../../../../src/security'
import { PartyDedicatedClient } from '../../../../../../../src/modules/party-service/adapters/party-dedicated-client'
  ...
  providers: [
    ...
    },
    {
      ...
      useValue: {
        ...
        forHumanOboInternalCall: async (source: unknown) => testTrustedMetadata(source)
      }
    },
    {
    ...
    {
      provide: GatewayTerminalDeviceGrpcClient,
      useFactory: (client: any) => ({ getClient: () => client }),
      inject: [getGrpcClientToken(SERVICE_NAMES.TERMINAL_DEVICE)]
    },
    {
...
@Module({
  ...
  providers: [
    ...
    GatewayExceptionFilter,
    {
      ...
      useValue: { create: async (source: unknown) => testTrustedMetadata(source) }
    },
    GatewayPermissionGuard,

...
import { ManufacturableItemLookupPort } from '../application/ports/manufacturable-item-lookup.port'
...
import { MesAuditEnvelopeRecord, MesCommandIdempotencyRecord, MesOutboxEventRecord } from '../domain/models/mes-mold-records'
import {
...
/** FakeSpecRepository stores spec records, audit, outbox, and idempotency records in process for Unit behavior tests. */
...
describe('mes-service production spec application behavior Unit', () => {

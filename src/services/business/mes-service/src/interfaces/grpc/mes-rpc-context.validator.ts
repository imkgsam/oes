import {
  ...
  assertTraceContext
} from '../../application/support/mes-assertions'
import { MesAuditContext, MesOperatorContext, MesQueryContext, MesTraceContext } from '../../domain/models/mes-mold-records'

export interface MesManagementContext extends MesQueryContext {
  auditContext: MesAuditContext
}

/** MesRpcContextValidator validates explicit tenant, operator, trace, and audit contexts frozen in MES contracts. */
export class MesRpcContextValidator {
  /** assertQueryContext validates read-path explicit tenant, operator, and trace context payload. */
  ...
  /** assertManagementContext validates write-path explicit tenant, operator, trace, and audit contexts. */

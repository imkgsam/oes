...
import { UpdateQuoteDraftCommand } from '../../src/application/commands/update-quote-draft.command'
import { UpdateQuoteDraftHandler } from '../../src/application/commands/update-quote-draft.handler'
...
import { SetOrderCommercialGateCommand } from '../../src/application/commands/set-order-commercial-gate.command'
import { SetOrderCommercialGateHandler } from '../../src/application/commands/set-order-commercial-gate.handler'
import { SubmitFulfillmentHandoffCommand } from '../../src/application/commands/submit-fulfillment-handoff.command'
import { SubmitFulfillmentHandoffHandler } from '../../src/application/commands/submit-fulfillment-handoff.handler'
import { GetQuoteQuery } from '../../src/application/queries/get-quote.query'
import { GetQuoteHandler } from '../../src/application/queries/get-quote.handler'
import { SearchQuotesQuery } from '../../src/application/queries/search-quotes.query'
import { SearchQuotesHandler } from '../../src/application/queries/search-quotes.handler'
import { GetQuoteVersionQuery } from '../../src/application/queries/get-quote-version.query'
import { GetQuoteVersionHandler } from '../../src/application/queries/get-quote-version.handler'
import { ListQuoteVersionsQuery } from '../../src/application/queries/list-quote-versions.query'
import { ListQuoteVersionsHandler } from '../../src/application/queries/list-quote-versions.handler'
import { GetSalesOrderQuery } from '../../src/application/queries/get-sales-order.query'
import { GetSalesOrderHandler } from '../../src/application/queries/get-sales-order.handler'
...
describe('sales-service behavior L1', () => {

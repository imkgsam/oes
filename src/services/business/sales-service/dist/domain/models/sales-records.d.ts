...
export declare enum SalesFulfillmentHandoffStatus {
...
export declare function buildInitialCommercialGateSummary(orderEstablished: boolean): CommercialGateSummary;
/** buildInitialHandoffSummary creates the phase 1 sales-side handoff summary before submission. */
export declare function buildInitialHandoffSummary(): FulfillmentHandoffSummary;

...
exports.CustomerRpcContextValidator = void 0;
...
class CustomerRpcContextValidator {
    ...
    static assertQueryContext(request) {
        (0, crm_assertions_1.assertRequiredString)(request.tenantId ?? '', 'tenantId');
        return {
            tenantId: request.tenantId ?? '',
            operatorContext: (0, crm_assertions_1.assertOperatorContext)(request.operatorContext
                ? {
                ...
                : null),
            traceContext: (0, crm_assertions_1.assertTraceContext)(request.traceContext
                ? {
    ...
    static assertManagementContext(request) {
        ...
        return {
            ...queryContext,
            auditContext: (0, crm_assertions_1.assertAuditContext)(request.auditContext
                ? {
...
exports.CustomerRpcContextValidator = CustomerRpcContextValidator;
//# sourceMappingURL=customer-rpc-context.validator.js.map
...
import { WmsItemMasterMachineSourceCredentialClient } from './wms-item-master-machine-source-credential.client'

/** Installs WMS's verified source credential only for the duration of one STS exchange. */
export class WmsItemMasterMachineSourceCredentialProvider {
  constructor(
    private readonly client: WmsItemMasterMachineSourceCredentialClient,

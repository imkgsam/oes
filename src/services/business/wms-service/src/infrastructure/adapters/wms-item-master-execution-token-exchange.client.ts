...
/** Exchanges WMS's private source credential for one target-bound Item Master token. */
export class WmsItemMasterExecutionTokenExchangeClient implements ExecutionTokenExchangeClient {

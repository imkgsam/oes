...
import { AddOrReplaceReceiptLinesCommand } from '../../src/application/commands/add-or-replace-receipt-lines.command'
import { AddOrReplaceReceiptLinesHandler } from '../../src/application/commands/add-or-replace-receipt-lines.handler'
import { CancelReceiptDraftCommand } from '../../src/application/commands/cancel-receipt-draft.command'
import { CancelReceiptDraftHandler } from '../../src/application/commands/cancel-receipt-draft.handler'
...
import { PostReceiptCommand } from '../../src/application/commands/post-receipt.command'
import { PostReceiptHandler } from '../../src/application/commands/post-receipt.handler'
import { ReceivingExpectationLookupPort, ReceivingExpectationLookupResult } from '../../src/application/ports/receiving-expectation-lookup.port'
import { StockableItemLookupPort, StockableItemLookupResult } from '../../src/application/ports/stockable-item-lookup.port'
import { GetInventoryBalanceHandler } from '../../src/application/queries/get-inventory-balance.handler'
import { GetInventoryBalanceQuery } from '../../src/application/queries/get-inventory-balance.query'
import { GetReceiptHandler } from '../../src/application/queries/get-receipt.handler'
import { GetReceiptQuery } from '../../src/application/queries/get-receipt.query'
import { SearchInventoryBalancesHandler } from '../../src/application/queries/search-inventory-balances.handler'
import { SearchInventoryBalancesQuery } from '../../src/application/queries/search-inventory-balances.query'
import { SearchReceiptLinesHandler } from '../../src/application/queries/search-receipt-lines.handler'
import { SearchReceiptLinesQuery } from '../../src/application/queries/search-receipt-lines.query'
import { SearchReceiptsHandler } from '../../src/application/queries/search-receipts.handler'
import { SearchReceiptsQuery } from '../../src/application/queries/search-receipts.query'
import { SearchStockLedgerEntriesHandler } from '../../src/application/queries/search-stock-ledger-entries.handler'
import { SearchStockLedgerEntriesQuery } from '../../src/application/queries/search-stock-ledger-entries.query'
import {
...
import { InMemoryInventoryRepository } from '../../src/infrastructure/repositories/in-memory/in-memory-inventory.repository'
import { InMemoryReceiptRepository } from '../../src/infrastructure/repositories/in-memory/in-memory-receipt.repository'
import { InMemoryWarehouseRepository } from '../../src/infrastructure/repositories/in-memory/in-memory-warehouse.repository'
import { WmsInMemoryStore } from '../../src/infrastructure/store/wms-in-memory-store'

/** StubStockableItemLookupPort lets L1 drive item-master validation outcomes without reaching another service. */
...
/** StubReceivingExpectationLookupPort lets L1 drive procurement expectation visibility without reaching another service. */
...
describe('wms-service behavior L1', () => {

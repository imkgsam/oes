import { BatchCreatePermissionsRequest, CreatePermissionRequest, UpdatePermissionRequest, DeletePermissionRequest, GetPermissionByCodeRequest, ListPermissionRolesRequest, ListPermissionsResponse, ListPermissionsPagedRequest, PagedPermissionsResponse, PermissionResponse, CreateRoleTemplateRequest, CreateRoleInstanceRequest, GetRoleTemplateByIdRequest, UpdateRoleTemplateRequest, DeleteRoleTemplateRequest, SetRoleTemplateEnabledRequest, ListRoleTemplatePermissionsRequest, AssignRoleTemplatePermissionRequest, RevokeRoleTemplatePermissionRequest, CreateRoleInstanceFromTemplateRequest, UpdateRoleRequest, SetRoleEnabledRequest, DeleteRoleRequest, GetRoleByIdRequest, ListRoleInstancesRequest, ListRolePermissionsRequest, ListRoleAccountsRequest, GetAccountRoleSelectionRequest, AccountRoleSelectionResponse, ListAuditEventsRequest, ListAuditEventsResponse, SetAccountRolesRequest, ListRoleTemplatesRequest, ListRolesResponse, ListRoleAccountsResponse, PagedRolesResponse, RoleResponse } from '../../generated/permission_service/permission_management';
export interface PermissionManagementPort {
    ...
    getAccountRoleSelection(req: GetAccountRoleSelectionRequest): Promise<AccountRoleSelectionResponse>;

...
import { InternalServiceAuthenticationResult, InternalServicePrincipal } from './internal-service-auth.types';
import { InternalCallMetadataInput, OperatorScopedMetadataInput } from './grpc-metadata-propagation.types';

...
const srm_infrastructure_module_1 = require("./modules/srm-infrastructure.module");
const srm_management_module_1 = require("./modules/srm-management.module");
const srm_query_module_1 = require("./modules/srm-query.module");
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            logging_1.LoggingModule.forRoot({ serviceName: 'srm-service' }),
            ...
            srm_infrastructure_module_1.SrmInfrastructureModule,
            srm_query_module_1.SrmQueryModule,
            srm_management_module_1.SrmManagementModule
        ]
    })
], AppModule);

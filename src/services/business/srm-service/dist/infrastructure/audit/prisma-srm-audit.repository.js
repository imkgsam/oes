...
exports.PrismaSrmAuditRepository = void 0;
const common_1 = require("@nestjs/common");
const prisma_srm_record_mapper_1 = require("../repositories/prisma/prisma-srm-record.mapper");
const prisma_service_1 = require("../prisma/prisma.service");
/** PrismaSrmAuditRepository persists local SRM audit envelopes inside the service database. */
let PrismaSrmAuditRepository = class PrismaSrmAuditRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async append(envelope) {
        await this.prisma.getExecutionClient().srmAuditEnvelope.create({
            data: {
                ...
                details: prisma_srm_record_mapper_1.PrismaSrmRecordMapper.toInputJson(envelope.details)
            }
        });
    }
};
exports.PrismaSrmAuditRepository = PrismaSrmAuditRepository;
exports.PrismaSrmAuditRepository = PrismaSrmAuditRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], PrismaSrmAuditRepository);
//# sourceMappingURL=prisma-srm-audit.repository.js.map
...
/** FailOnceAuditWriter forces the success audit append to fail so Integration can verify transaction rollback. */
...
function createTrustedHumanContext(prefix: string, tenantId: string) {
  ...
  return {
    verifiedExecutionToken: {
      ...
      principalType: 'HUMAN',
      clientId: 'spiffe://oes/procurement-integration-client',
      tenantId,
      orgId: `${prefix}_org`,
      permissionCodes: [],
    ...
    verifiedWorkloadIdentity: {
      spiffeId: 'spiffe://oes/procurement-integration-client',
      certificateThumbprint
    },
...
describe('procurement audit transaction Integration', () => {

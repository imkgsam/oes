...
const procurement_infrastructure_module_1 = require("./modules/procurement-infrastructure.module");
const procurement_management_module_1 = require("./modules/procurement-management.module");
const procurement_query_module_1 = require("./modules/procurement-query.module");
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            logging_1.LoggingModule.forRoot({ serviceName: 'procurement-service' }),
            ...
            transport_1.GrpcTransportModule.forRoot({
                services: {
                    ...
                    [constants_1.SERVICE_NAMES.SRM]: {
                        serviceName: constants_1.SERVICE_NAMES.SRM,
            ...
            procurement_infrastructure_module_1.ProcurementInfrastructureModule,
            procurement_query_module_1.ProcurementQueryModule,
            procurement_management_module_1.ProcurementManagementModule
        ]
    })
], AppModule);

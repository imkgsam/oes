...
let GetPurchaseRequestHandler = class GetPurchaseRequestHandler {
    ...
    async execute(query) {
        ...
        return (0, procurement_assertions_1.assertExists)(await this.purchaseRequestRepository.findById(query.tenantId, query.purchaseRequestId), 'purchase_request', query.purchaseRequestId);
    }
};

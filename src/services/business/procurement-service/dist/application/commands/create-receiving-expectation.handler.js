...
exports.CreateReceivingExpectationHandler = void 0;
...
const create_receiving_expectation_command_1 = require("./create-receiving-expectation.command");
/** CreateReceivingExpectationHandler creates the procurement-side expectation summary from one issued PO line only. */
let CreateReceivingExpectationHandler = class CreateReceivingExpectationHandler {
    ...
    async execute(command) {
        ...
        return this.receivingRepository.save({
            ...
            expectedReceiptDate: (0, procurement_assertions_1.normalizeOptionalString)(command.payload.expectedReceiptDate) ?? null,
            status: procurement_records_1.ReceivingExpectationStatus.OPEN,
            createdAt,
            updatedAt: createdAt,
            discrepancy: null
        });
...
exports.CreateReceivingExpectationHandler = CreateReceivingExpectationHandler;
exports.CreateReceivingExpectationHandler = CreateReceivingExpectationHandler = __decorate([
    (0, common_1.Injectable)(),
    (0, cqrs_1.CommandHandler)(create_receiving_expectation_command_1.CreateReceivingExpectationCommand),
...
//# sourceMappingURL=create-receiving-expectation.handler.js.map
...
/** Exchanges Procurement's verified HUMAN current-hop credential for an SRM target token. */
export class ProcurementSrmExecutionTokenExchangeClient implements ExecutionTokenExchangeClient {

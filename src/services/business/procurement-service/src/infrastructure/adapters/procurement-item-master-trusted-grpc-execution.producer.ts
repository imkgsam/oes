...
/** Produces exact INTERNAL Item Master metadata from PROCUREMENT's SYSTEM MACHINE identity. */
export class ProcurementItemMasterTrustedGrpcExecutionProducer {
...
/** Requires PROCUREMENT's deployment-owned trust facts and fails before transport on gaps. */

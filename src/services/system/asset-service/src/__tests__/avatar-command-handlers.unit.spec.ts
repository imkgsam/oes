...
import { BindAccountAvatarCommand } from '../application/commands/avatar/bind-account-avatar.command'
import {
  BindAccountAvatarHandler
} from '../application/commands/avatar/bind-account-avatar.handler'
import { BindEmployeeOfficialPhotoCommand } from '../application/commands/avatar/bind-employee-official-photo.command'
import {
  BindEmployeeOfficialPhotoHandler
} from '../application/commands/avatar/bind-employee-official-photo.handler'
import { UploadAccountAvatarCommand } from '../application/commands/avatar/upload-account-avatar.command'
import { UploadAccountAvatarHandler } from '../application/commands/avatar/upload-account-avatar.handler'
import { UploadEmployeeOfficialPhotoCommand } from '../application/commands/avatar/upload-employee-official-photo.command'
import {
  UploadEmployeeOfficialPhotoHandler
} from '../application/commands/avatar/upload-employee-official-photo.handler'
import {
  S3CompatibleObjectStorageAdaptor
} from '../infrastructure/adaptors/storage/s3-compatible-object-storage.adaptor'

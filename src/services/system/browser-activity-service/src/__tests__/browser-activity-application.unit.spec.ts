import { createInMemoryBrowserActivityApplication } from '../application/testing/create-in-memory-browser-activity-application'
import { BrowserActivityApplication } from '../application/browser-activity-application'

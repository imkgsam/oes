...
// PrismaService owns browser-activity-service database access and lifecycle.
@Injectable()
export class PrismaService extends PrismaClient implements OnModuleInit, OnModuleDestroy {
  // Constructs the service-scoped Prisma client with the browser-activity-service database URL.

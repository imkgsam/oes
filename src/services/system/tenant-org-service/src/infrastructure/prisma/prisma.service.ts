...
/** PrismaService manages the tenant-org-service database connection lifecycle. */
@Injectable()
export class PrismaService extends PrismaClient implements OnModuleInit, OnModuleDestroy {
  ...
  async onModuleInit() {
    try {
      ...
      this.logger.error('[TENANT_ORG_SERVICE] PrismaService connection failed', exception)
      process.exit(1)
    }
  }

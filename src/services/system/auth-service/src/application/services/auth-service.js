...
const jwt_service_1 = require("src/infrastructure/jwt/jwt.service");
...
let AuthService = class AuthService {
    ...
    phoneOtpProvider;
    jwtService;
    constructor(emailProvider, googleProvider, wechatProvider, emailOtpProvider, phoneOtpProvider, jwtService) {
...
exports.AuthService = AuthService = __decorate([
    ...
    __metadata("design:paramtypes", [email_password_provider_1.EmailPasswordAuthProvider,
        ...
        otp_provider_1.PhoneOtpProvider, typeof (_a = typeof jwt_service_1.JwtService !== "undefined" && jwt_service_1.JwtService) === "function" ? _a : Object])
], AuthService);

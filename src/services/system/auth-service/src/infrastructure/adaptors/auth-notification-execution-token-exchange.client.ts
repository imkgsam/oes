...
/** Exchanges only Common-carrier metadata for a target-bound Notification ExecutionToken. */
export class AuthNotificationExecutionTokenExchangeClient implements ExecutionTokenExchangeClient {

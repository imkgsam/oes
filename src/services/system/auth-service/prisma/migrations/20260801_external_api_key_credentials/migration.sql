CREATE TABLE "ExternalApiKeyCredential" (
 ...
 "keyIdentifier" TEXT NOT NULL UNIQUE, "verifier" TEXT NOT NULL, "verifierKeyVersion" TEXT NOT NULL,
 "status" TEXT NOT NULL DEFAULT 'ACTIVE', "expiresAt" TIMESTAMP(3) NOT NULL,
 "supersedesCredentialId" TEXT, "predecessorValidUntil" TIMESTAMP(3), "revokedAt" TIMESTAMP(3), "lastUsedAt" TIMESTAMP(3),

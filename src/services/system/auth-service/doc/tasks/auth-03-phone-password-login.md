...
更新时间：2026-03-23 23:44:40 +09:00
...
- 手机号规范化规则尚未统一，当前仍直接依赖现有标识符存储与 DTO 校验

## 2026-03-23 Incremental Update

- 已新增 `LoginWithPhonePassword` gRPC 入口
- 已新增手机密码认证 strategy / command / handler
- 已复用现有 MFA challenge 与账户选择编排

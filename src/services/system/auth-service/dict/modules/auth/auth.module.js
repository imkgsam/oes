...
const auth_domain_service_1 = require("../../domain/services/auth.domain-service");
const jwt_module_1 = require("../../infrastructure/jwt/jwt.module");
const auth_local_controller_1 = require("../../interfaces/http/controllers/auth/auth-local.controller");
const auth_local_controller_2 = require("../../interfaces/tcp/controllers/auth/auth-local.controller");

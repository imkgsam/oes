...
import { NotificationEventOperationsService } from '../infrastructure/events/operations/notification-event-operations.service'
import { NotificationSafeRedeliveryJob } from '../infrastructure/events/operations/notification-safe-redelivery.job'

/** Verifies the one-off replay job reuses Notification's typed handler and never gains a business-event publish path. */
describe('NotificationSafeRedeliveryJob Unit', () => {

...
export class ListAccountWorkPhoneAssetsHandler
  implements IQueryHandler<ListAccountWorkPhoneAssetsQuery, AccountContactAssetEntity[]>
{
  constructor(
  ...
  execute(query: ListAccountWorkPhoneAssetsQuery): Promise<AccountContactAssetEntity[]> {

...
let AdminService = class AdminService {
  ...
  async createUser(dto) {
    ...
    if (found) throw new common_1.BadRequestException('User Exists')
...
exports.AdminService = AdminService = __decorate(
  [
    ...
    __metadata('design:paramtypes', [
      typeof (_a =
        typeof user_repository_1.IUserRepository !== 'undefined' &&
        user_repository_1.IUserRepository) === 'function'
        ? _a
        : Object
    ])
  ],

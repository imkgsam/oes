...
import { AssignAccountWorkEmailAssetCommand } from '../application/commands/contact/assign-account-work-email-asset.command'
import { AssignAccountWorkEmailAssetHandler } from '../application/commands/contact/assign-account-work-email-asset.handler'
import {

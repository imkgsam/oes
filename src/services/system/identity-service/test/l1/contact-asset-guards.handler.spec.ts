...
import { RevokeAccountWorkPhoneAssetCommand } from '../../src/application/commands/contact/revoke-account-work-phone-asset.command'
import { RevokeAccountWorkPhoneAssetHandler } from '../../src/application/commands/contact/revoke-account-work-phone-asset.handler'
...
import { SetAccountPrimaryWorkPhoneAssetCommand } from '../../src/application/commands/contact/set-account-primary-work-phone-asset.command'
import { SetAccountPrimaryWorkPhoneAssetHandler } from '../../src/application/commands/contact/set-account-primary-work-phone-asset.handler'
...
import { SetAccountWorkPhoneAssetStatusCommand } from '../../src/application/commands/contact/set-account-work-phone-asset-status.command'
import { SetAccountWorkPhoneAssetStatusHandler } from '../../src/application/commands/contact/set-account-work-phone-asset-status.handler'
import {

...
## 2026-04-06 11:20:00 +08:00

### 本次目标

补齐角色与账号角色管理链路中仍未完全落到服务内的系统范围 / 租户范围约束。

### 主要改动

- 为模板角色相关写操作与权限查看补齐系统范围校验
- 为角色实例详情、权限查看、账号查看以及实例写操作补齐当前租户范围校验
- 为账号角色相关读写操作补齐当前租户范围校验
- 同步更新设计文档，修正 `4.2.11` 的过时说明，并将 `4.2.23` 更新为与实际代码一致的状态

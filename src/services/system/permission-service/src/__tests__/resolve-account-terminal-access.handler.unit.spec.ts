import { ResolveAccountTerminalAccessHandler } from '../application/queries/terminal-access/resolve-account-terminal-access.handler'
import { ResolveAccountTerminalAccessQuery } from '../application/queries/terminal-access/resolve-account-terminal-access.query'

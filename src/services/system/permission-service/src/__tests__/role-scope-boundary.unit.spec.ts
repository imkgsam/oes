...
import { CreateRoleTemplateHandler } from '../application/commands/role/create-role-template.handler'
import { AssignRolePermissionCommand } from '../application/commands/role/assign-role-permission.command'
import { AssignRolePermissionHandler } from '../application/commands/role/assign-role-permission.handler'
...
} from '../application/authorization/operator-scope'

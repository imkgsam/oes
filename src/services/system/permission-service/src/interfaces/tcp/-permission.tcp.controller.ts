...
import { CheckAccountPermissionQuery } from 'src/application/queries/authorization'
...
export class TcpPermissionController {
  ...
  checkUserPermission(
    ...
    return this.queryBus.execute(new CheckAccountPermissionQuery(data.userId, data.permissionCode))
  }

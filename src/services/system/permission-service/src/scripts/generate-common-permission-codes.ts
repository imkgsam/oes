...
const COMMON_PERMISSION_CODE_FILES: CommonPermissionCodeFileDefinition[] = [
  ...
  {
    kind: 'index',
    relativePath: 'notification/index.ts',
    exports: ['./internal.permission-codes']
  },
  {
    kind: 'const',
    relativePath: 'notification/internal.permission-codes.ts',
    constName: 'NOTIFICATION_INTERNAL_PERMISSION_CODES',
    records: NOTIFICATION_INTERNAL_PERMISSION_CODES
  },
  {
    kind: 'index',
  ...
  {
    kind: 'const',
    relativePath: 'terminal-device/internal.permission-codes.ts',
    constName: 'TERMINAL_DEVICE_INTERNAL_PERMISSION_CODES',
    records: TERMINAL_DEVICE_INTERNAL_PERMISSION_CODES
  },
  {
    kind: 'index',

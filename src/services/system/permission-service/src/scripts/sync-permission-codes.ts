...
const PERMISSION_DESCRIPTION_BY_CODE: Readonly<Record<string, string>> = {
  ...
  'crm.customer_account.list': '查看 CRM 客户账户列表',
  'crm.customer_account.get_by_id': '查看 CRM 客户账户详情',
  'crm.customer_account.search_selectable': '查看可进入交易链的 CRM 客户选择结果',
  'crm.customer_account.create': '创建 CRM 客户账户外壳',
  'crm.customer_account.update_basics': '更新 CRM 客户账户基础信息',
  'crm.customer_account.bind_tenant_party': '绑定 CRM 客户账户到租户主体',
  'crm.customer_account.change_status': '切换 CRM 客户账户状态',
  'crm.customer_contact.upsert': '新增或更新 CRM 客户联系人',
  'crm.customer_address.upsert': '新增或更新 CRM 客户地址',

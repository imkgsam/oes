...
@Injectable()
@CommandHandler(SetItemCapabilitiesCommand)
export class SetItemCapabilitiesHandler implements ICommandHandler<SetItemCapabilitiesCommand, Item> {
  constructor(
    @Inject(TOKENS.ITEM_REPOSITORY)
    private readonly itemRepository: ItemRepository
  ) {}

  async execute(command: SetItemCapabilitiesCommand): Promise<Item> {

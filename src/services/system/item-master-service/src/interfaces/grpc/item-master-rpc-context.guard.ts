...
/** Maps only the verified ExecutionToken tenant into the application input consumed by Item Master. */
@Injectable()
export class ItemMasterVerifiedTenantContextGuard implements CanActivate {

...
exports.ScopeControllGuard = void 0;
const common_1 = require("@nestjs/common");
const core_1 = require("@nestjs/core");
const microservices_1 = require("@nestjs/microservices");
const scope_check_decorator_1 = require("../decorators/scope-check.decorator");
...
let ScopeControllGuard = class ScopeControllGuard {
    reflector;
    ...
    async canActivate(context) {
        const metadata = this.reflector.get(scope_check_decorator_1.SCOPE_CHECK_KEY, context.getHandler());
        if (!metadata)
            return true;
...
exports.ScopeControllGuard = ScopeControllGuard;
exports.ScopeControllGuard = ScopeControllGuard = __decorate([
    (0, common_1.Injectable)(),
    __param(1, (0, client_decorator_1.InjectServiceClient)('PERMISSION_TCP')),
    __metadata("design:paramtypes", [core_1.Reflector,
        microservices_1.ClientProxy])
], ScopeControllGuard);
//# sourceMappingURL=scope-controll.guard.js.map
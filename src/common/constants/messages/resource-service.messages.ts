...
export const RESOURCE_SERVICE_MESSAGES = {
   ...
   */
  UPDATE_DOMAIN_DESCRIPTION: 'domain.update_description',
   ...
   * 参数：{ domainId: string, userId: string, tenantId: string }
   */
  FIND_DOMAIN_BY_ID: 'domain.find_by_id',
   ...
   */
  FIND_DOMAIN_BY_VALUE: 'domain.find_by_value',
   ...
   */
  FIND_DOMAINS_BY_TENANT: 'domain.find_by_tenant',
   ...
   */
  FIND_DOMAINS_PAGINATED: 'domain.find_paginated',
   ...
   * 参数：{ tenantId: string, userId: string }
   */
  GET_DOMAIN_STATISTICS: 'domain.get_statistics',
   ...
   */
  UPDATE_DNS_RECORD: 'dns.update_record',
   ...
   */
  FIND_DNS_RECORDS: 'dns.find_records',
   ...
   */
  VERIFY_DNS_RECORDS: 'dns.verify_records',
   ...
   */
  GENERATE_VERIFICATION_CHALLENGE: 'verification.generate_challenge',
   ...
   */
  VERIFY_DOMAIN: 'verification.verify_domain',
   ...
   * 参数：{ domainId: string, userId: string, tenantId: string }
   */
  GET_VERIFICATION_STATUS: 'verification.get_status',
   ...
   */
  ADMIN_CREATE_DOMAIN: 'admin.domain.create',
   ...
   */
  ADMIN_UPDATE_DOMAIN: 'admin.domain.update',
   ...
   */
  ADMIN_DELETE_DOMAIN: 'admin.domain.delete',
   ...
   */
  ADMIN_FIND_ALL_DOMAINS: 'admin.domain.find_all',
   ...
   */
  ADMIN_ADD_DNS_RECORD: 'admin.dns.add_record',
   ...
   */
  ADMIN_UPDATE_DNS_RECORD: 'admin.dns.update_record',
   ...
   */
  ADMIN_REMOVE_DNS_RECORD: 'admin.dns.remove_record',
   ...
   */
  ADMIN_VERIFY_DOMAIN: 'admin.verification.verify_domain',
   ...
   */
  ADMIN_FORCE_VERIFY_DOMAIN: 'admin.verification.force_verify',
   ...
   */
  ADMIN_GET_ALL_STATISTICS: 'admin.get_all_statistics',
   ...
   */
  ADMIN_GET_TENANT_STATISTICS: 'admin.get_tenant_statistics',

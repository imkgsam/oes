...
| **worktree total** | **37** | MACHINE source worktree clean at integrated `02457959…`并标记`MERGED_PRESERVE_UNTIL_FINAL_CLEANUP`；root与Program Control核验面clean。删除/clean/reset数为0 |

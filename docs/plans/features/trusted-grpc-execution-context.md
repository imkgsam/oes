...
notificationAuthDispatchTrustedGrpcImplementationLease:
  ...
  focusedAcceptanceCommands:
    ...
    - pnpm exec jest --config package.json --runInBand --runTestsByPath src/services/system/auth-service/src/infrastructure/adaptors/auth-notification-execution-token-exchange.client.spec.ts src/services/system/auth-service/src/infrastructure/adaptors/auth-notification-machine-source-credential.client.spec.ts src/services/system/auth-service/src/infrastructure/adaptors/auth-notification-machine-source-credential.provider.spec.ts src/services/system/auth-service/src/infrastructure/adaptors/auth-notification-trusted-grpc-execution.producer.spec.ts
    - pnpm exec jest --config package.json --runInBand --runTestsByPath src/services/system/auth-service/src/infrastructure/adaptors/notification-service.grpc.adaptor.spec.ts src/services/system/auth-service/src/application/services/email-otp-login.service.spec.ts src/services/system/auth-service/src/application/services/phone-otp-login.service.spec.ts src/services/system/auth-service/src/application/services/password-recovery.service.spec.ts src/services/system/auth-service/src/application/services/contact-binding-verification.service.spec.ts src/services/system/auth-service/src/application/services/mfa/email-otp-mfa-challenge.service.spec.ts src/services/system/auth-service/src/application/services/mfa/phone-otp-mfa-challenge.service.spec.ts src/services/system/auth-service/src/modules/auth/auth.module.spec.ts

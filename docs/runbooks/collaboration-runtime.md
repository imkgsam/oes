...
2. Install/read back the rendered bytes and SHA-256. The trusted authorization root remains owner-read-only; the serial root contains only the shared exact lock.

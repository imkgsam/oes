...
> 当前 `permission-service` 服务职责、核心对象与 owner 边界以 [permission-service.md](../architecture/services/permission-service.md) 为准；本 ADR 只保留统一 Web shell 与 scope-aware account 的架构决策记录。

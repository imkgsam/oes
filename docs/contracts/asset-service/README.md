...
- [avatar.md](./avatar.md)
  - 头像资产上传、绑定、替换与地址解析契约
- [employee-official-photo.md](./employee-official-photo.md)
  - 员工公开展示头像资产上传、绑定与地址解析契约
- [site-media.md](./site-media.md)
  - tenant-scoped Site 图片 / 视频的上传、选择、发布期解析、公开交付、引用保护与受控下架契约

相关的 Asset 公共可订阅事件以 [asset-service Event Contract](../events/asset-service.md) 为准。
...
- 五个既有 RPC 的 mode、Permission Code、字段处置与 caller policy 以 [asset-service.md §10.5](../../architecture/services/asset-service.md) 为唯一稳定设计，以 [avatar.md](./avatar.md) 与 [employee-official-photo.md](./employee-official-photo.md) 为黑盒行为契约

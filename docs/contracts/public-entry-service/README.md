...
> 服务设计唯一真相源：[public-entry-service.md](../../architecture/services/public-entry-service.md)。本目录只描述 `public-entry-service` 的黑盒契约，不重新定义服务长期职责、ShortLink / BusinessCard owner 边界或 target resolver 模型。

Phase 1 contracts:

- [shortlink-public-redirect.md](./shortlink-public-redirect.md)
- [shortlink-admin-management.md](./shortlink-admin-management.md)
- [shortlink-target-resolver.md](./shortlink-target-resolver.md)
- [business-card-management.md](./business-card-management.md)
- [business-card-self-view.md](./business-card-self-view.md)
- [business-card-public-render.md](./business-card-public-render.md)

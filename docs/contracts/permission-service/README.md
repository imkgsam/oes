...
> 服务设计唯一真相源：[permission-service.md](../../architecture/services/permission-service.md)。本目录只描述 `permission-service` 对外黑盒 contract，不重新定义 Permission、Role、PrincipalRoleBinding、Policy、access summary、navigation governance、terminal access 或 onboarding grant 的长期 owner 边界。
...
- [terminal-access.md](./terminal-access.md)
...
- [onboarding-grant.md](./onboarding-grant.md)
  - Employee onboarding initial role / grant handoff contract.

涉及 HR `Employee / Employment`、员工生命周期或 onboarding owner 边界时，以 [hr-service.md](../../architecture/services/hr-service.md) 为准；本目录只描述 permission contract 如何消费 employee onboarding 授权 handoff。
- [tenant-onboarding-grant.md](./tenant-onboarding-grant.md)
  - Tenant onboarding first-admin role instance and initial grant target contract.
- [resource-authorization.md](./resource-authorization.md)
...
- [policy-instance-management.md](./policy-instance-management.md)
...
- [principal-authorization.md](./principal-authorization.md)
...
- [delegated-authorization.md](./delegated-authorization.md)
...
- [permission_check.proto](../../../src/common/src/contracts/permission_service/permission_check.proto)
- [permission_terminal_access.proto](../../../src/common/src/contracts/permission_service/permission_terminal_access.proto)
...
- [policy_instance_preview.proto](../../../src/common/src/contracts/permission_service/policy_instance_preview.proto)

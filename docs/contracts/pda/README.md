...
> PDA contract 只描述终端侧 JS Bridge 与 BFF 消费边界，不拥有 terminal access、access summary、Role、Policy 或授权判定真相；这些以 [permission-service.md](../../architecture/services/permission-service.md) 为准。
...
| Contract | Purpose |
| --- | --- |
| [js-bridge.md](./js-bridge.md) | Cross-device PDA capability contract between Android Shell and Vue3 PDA Web. |

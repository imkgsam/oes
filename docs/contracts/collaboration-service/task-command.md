...
> `collaboration-service` 的服务职责、核心对象、owner 边界与长期命名以 [collaboration-service.md](../../architecture/services/collaboration-service.md) 为唯一稳定真相源。本文只描述 Task P1 command 黑盒契约。

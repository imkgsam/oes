...
describe('tenant-web policy instance management api', () => {
  ...
  it('lists readonly PolicyInstance records with governance filters', async () => {
    const { listPolicyInstancesApi } = await import('../../../../src/api/bff/policy-instance-management/index');
  ...
  it('loads one readonly PolicyInstance detail by stable id', async () => {
    const { getPolicyInstanceByIdApi } = await import('../../../../src/api/bff/policy-instance-management/index');
  ...
  it('creates one PolicyInstance through the dedicated mutation contract', async () => {
    const { createPolicyInstanceApi } = await import('../../../../src/api/bff/policy-instance-management/index');
  ...
  it('enables or disables one PolicyInstance by stable id', async () => {
    const { setPolicyInstanceEnabledApi } = await import('../../../../src/api/bff/policy-instance-management/index');
